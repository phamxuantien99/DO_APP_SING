...
import {componentsTitleMap, sortOrder} from '../../HomeInternal/HomeInternal';
import {Listcomponent} from '../LastestProjects';

export default function SeeAllSlide() {
