...
export default function DetailProjectDoneInternal() {
        ...
        <View style={styles.box}>
          ...
          <View style={{backgroundColor: 'white'}}>
            ...
            {dataDetailID?.loading_by !== null &&
              dataDetailID?.loading_by === userInfo?.user_info?.user_name && (
                <View
                  style={{
                    display: 'flex',
                    flexDirection: 'row',
            ...
            {dataDetailID?.driver_by !== null &&
              dataDetailID?.driver_by === userInfo?.user_info?.user_name && (
                <View
                  style={{
                    display: 'flex',
                    flexDirection: 'row',
            ...
            {dataDetailID?.unload_by !== null &&
              dataDetailID?.unload_by === userInfo?.user_info?.user_name && (
                <View
                  style={{
                    display: 'flex',
                    flexDirection: 'row',
